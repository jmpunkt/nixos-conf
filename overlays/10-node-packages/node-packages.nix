...
let
  sources = {
    ...
    "https-proxy-agent-2.2.3" = {
      ...
      version = "2.2.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/https-proxy-agent/-/https-proxy-agent-2.2.3.tgz";
        sha512 = "Ytgnz23gm2DVftnzqRRz2dOXZbGd2uiajSw/95bPp6v53zPRspQjLm/AfBgqbJ2qfeRXWIOMVLpp86+/5yX39Q==";
      };
    };
    "iconv-lite-0.4.24" = {
      name = "iconv-lite";
...
in
{
  ...
  coc-yaml = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."https-proxy-agent-2.2.3"
      sources."js-yaml-3.13.1"
