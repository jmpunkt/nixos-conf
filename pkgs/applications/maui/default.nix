{
  ...
  vvave =
    ...
    rec {
      ...
      gstBuildInputs = with gst_all_1; [gstreamer gst-libav gst-vaapi gst-plugins-base gst-plugins-good gst-plugins-bad gst-plugins-ugly];
      buildInputs =
        [
          kconfig
          kio
...
in {inherit pix clip nota index-fm vvave;}
