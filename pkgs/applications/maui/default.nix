...
let
  ...
  vvave = mkDerivation rec {
    ...
    qtWrapperArgs = [ ''--prefix GST_PLUGIN_PATH : "${lib.concatMapStringsSep ":" (p: "${p}/lib/gstreamer-1.0") gstBuildInputs}"'' ];
